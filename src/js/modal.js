;(function(){
    ...
    function openModal(e) {
        ...
        switch(contentType) {
            ...
            case "monitor":
                modalWindow.classList.add("modal-window_monitor");
                let monitorHider = document.createElement('div');
                monitorHider.style.display = "none";
                let screen = document.createElement("img");
                screen.setAttribute('src', contentHref);
                screen.classList.add("modal-window_screen");
                document.body.appendChild(monitorHider);
                monitorHider.appendChild(screen);
                screen.onload = function() {
                    showModalContent(screen.outerHTML);
                    document.body.removeChild(monitorHider);
                };
                break;

            case "mobile":
                modalWindow.classList.add("modal-window_mobile");
                let mobileHider = document.createElement('div');
                mobileHider.style.display = "none";
                let mobile = document.createElement("img");
                mobile.setAttribute('src', contentHref);
                mobile.classList.add("modal-window_screen");
                document.body.appendChild(mobileHider);
                mobileHider.appendChild(mobile);
                mobile.onload = function() {
                    showModalContent(mobile.outerHTML);
                    document.body.removeChild(mobileHider);
                };
                break;
    ...
    function closeModal() {
        ...
        setTimeout(function(){
            ...
            modalWindow.classList.remove("modal-window_monitor");
            modalWindow.classList.remove("modal-window_mobile");
